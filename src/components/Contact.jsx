        ...
        <div className="grid md:grid-cols-2 place-items-center">
          ...
          >
            ...
            <input
              ...
              name="name"
              className="mb-2 w-full rounded-md border text-black border-purple-600 py-2 pl-2 pr-4"
            />
            <input
              type="email"
              id="email"
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-md text-gray-100 font-semibold text-xl bg-primary-color hover:bg-gray-500"
            >
              Send Message
            </button>
          </form>
